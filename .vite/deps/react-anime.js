...
var penner = (function() {
  ...
  var functionEasings = {
    ...
    Expo: function() {
      return function(t2) {
        return t2 ? Math.pow(2, 10 * t2 - 10) : 0;
      };
    },
    Circ: function() {
      return function(t2) {
...
function l() {
  return (l = Object.assign || function(r2) {
    for (var e2 = 1; e2 < arguments.length; e2++) {
      var t2 = arguments[e2];
      for (var n2 in t2) Object.prototype.hasOwnProperty.call(t2, n2) && (r2[n2] = t2[n2]);
    }
    return r2;
...
function a(r2, e2) {
  for (let t2 = 0; t2 < r2.length; t2++) {
    const n2 = r2[t2];
    Array.isArray(n2) ? a(n2, e2) : e2.push(n2);
  }
}
function s(a2) {
  const s2 = (0, import_react.useRef)([]), f = (0, import_react.useRef)([]), m = (0, import_react.useRef)([]), p = (0, import_react.useRef)(/* @__PURE__ */ new Set()), h = () => {
    for (let r2 of s2.current) r2.completed && (s2.current = s2.current.filter((e2) => e2 != r2));
    f.current = f.current.filter((r2) => null != r2 && null != r2), m.current = m.current.filter((r2) => r2 && null != r2.current);
  }, d = (0, import_react.useCallback)(() => {
    ((r2) => {
      h(), f.current.length > 0 && anime_es_default.remove(f), f.current = [];
      for (let r3 of m.current) r3.current && !p.current.has(r3.current) && f.current.push(r3.current);
      const e2 = l({}, r2, { targets: f.current, complete: (e3) => {
        r2.complete && r2.complete(e3), e3.animatables.map((r3) => p.current.add(r3.target)), h();
      } });
      delete e2.children, s2.current.push(anime_es_default(e2));
    })(a2);
  }, [a2]);
  ...
  const g = m.current;
  let y = Array.isArray(a2.children) ? a2.children : [a2.children];
  return y = i(y), (0, import_jsx_runtime.jsx)(import_react.Fragment, { children: y.map((e2, t2) => (g.push((0, import_react.createRef)()), (0, import_jsx_runtime.jsx)(a2.component ? a2.component : "div", Object.assign({ ref: g[g.length - 1] }, { children: e2 }), `__anime__${t2}`))) }, void 0);
}
var react_anime_modern_default = s;
export {
  anime_es_default as anime,
  react_anime_modern_default as default
};
