import {
  ...
  size,
  useFloating
} from "./chunk-RWCUVQOX.js";
import {
  require_react_dom
} from "./chunk-OE4GHL35.js";
import {
  require_jsx_runtime
} from "./chunk-4E53V7MH.js";
import {
  require_react
...
function getSingleElementChild(children) {
  ...
  if (_children.length !== 1 || !isElement2(_children[0])) {
    return null;
  }
  return _children[0];
}
...
function useMantineColorScheme({ keepTransitions } = {}) {
  ...
  const nonce = useMantineStyleNonce();
  const nonceValue = (0, import_react98.useRef)(nonce?.());
  if (!ctx) {
    throw new Error("[@mantine/core] MantineProvider was not found in tree");
  }
...
var index = isClient ? import_react118.useLayoutEffect : noop2;
var SafeReact = {
  ...React13
};
...
function getGridCellIndexOfCorner(index4, sizes2, cellMap, cols, corner) {
...
function isListIndexDisabled(listRef, index4, disabledIndices) {
  ...
  const element = listRef.current[index4];
...
function FloatingList(props) {
  ...
  const map = React14.useMemo(() => {
    ...
    sortedNodes.forEach((node, index4) => {
...
function useListItem(props) {
  ...
  const [index4, setIndex] = React14.useState(null);
  ...
  const ref = React14.useCallback((node) => {
    ...
    if (index4 !== null) {
      ...
      if (labelsRef) {
        ...
        labelsRef.current[index4] = isLabelDefined ? label : (_node$textContent = node == null ? void 0 : node.textContent) != null ? _node$textContent : null;
      }
    }
...
function FocusTrap({
  ...
  return (0, import_react145.cloneElement)(child, { [refProp]: ref });
}
...
var PopoverTarget = factory((props, ref) => {
  ...
  return (0, import_react147.cloneElement)(child, {
    ...forwardedProps,
    ...accessibleProps,
    ...ctx.targetProps,
...
var CloseIcon = (0, import_react158.forwardRef)(
  ({ size: size2 = "var(--cb-icon-size, 70%)", style, ...others }, ref) => (0, import_jsx_runtime76.jsx)(
    "svg",
    {
      viewBox: "0 0 15 15",
      fill: "none",
...
var Input = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime97.jsx)(InputContext, { value: { size: size2 || "sm" }, children: (0, import_jsx_runtime97.jsxs)(
    Box,
    {
      ...getStyles2("wrapper"),
      ...styleProps,
...
var AngleSlider = factory((_props, ref) => {
  ...
  const marksItems = marks?.map((mark, index4) => (0, import_react200.createElement)(
    "div",
    {
...
var ComboboxClearButton = (0, import_react221.forwardRef)(
  ({ size: size2, onMouseDown, onClick, onClear, ...others }, ref) => (0, import_jsx_runtime134.jsx)(
    Input.ClearButton,
    {
      ref,
      tabIndex: -1,
...
var ComboboxEventsTarget = factory((props, ref) => {
  ...
  return (0, import_react226.cloneElement)(child, {
    ...targetProps,
    ...others,
...
var ComboboxTarget = factory((props, ref) => {
  ...
  const clonedElement = (0, import_react233.cloneElement)(child, {
    ...targetProps,
    ...others
  });
...
function useCombobox({
  ...
  const selectActiveOption = (0, import_react234.useCallback)(() => {
    ...
    if (activeOption) {
      ...
      const index4 = items.findIndex((option) => option === activeOption);
  ...
  const updateSelectedOptionIndex = (0, import_react234.useCallback)(
    (target = "selected", options) => {
      selectedIndexUpdateTimeout.current = window.setTimeout(() => {
        ...
        const index4 = items.findIndex((option) => option.hasAttribute(`data-combobox-${target}`));
          ...
          Box,
          {
            ...
            children: [
              ...
              (0, import_jsx_runtime149.jsxs)("div", { ...getStyles2("labelWrapper"), "data-disabled": disabled || void 0, children: [
                ...
                description && (0, import_jsx_runtime149.jsx)(Input.Description, { size: size2, __inheritStyles: false, ...getStyles2("description"), children: description }),
                error2 && typeof error2 !== "boolean" && (0, import_jsx_runtime149.jsx)(Input.Error, { size: size2, __inheritStyles: false, ...getStyles2("error"), children: error2 })
              ] })
            ]
          }
        )
...
var CheckboxGroup = factory((props, ref) => {
  ...
  return (0, import_jsx_runtime153.jsx)(CheckboxGroupProvider, { value: { value: _value, onChange: handleChange, size: size2, disabled }, children: (0, import_jsx_runtime153.jsx)(
    Input.Wrapper,
    {
      size: size2,
      ref,
...
function OptionsDropdown({
  ...
  return (0, import_jsx_runtime157.jsx)(Combobox.Dropdown, { hidden: hidden2 || hiddenWhenEmpty && isEmpty, "data-composed": true, children: (0, import_jsx_runtime157.jsxs)(Combobox.Options, { labelledBy: labelId, "aria-label": ariaLabel, children: [
...
var Breadcrumbs = factory((_props, ref) => {
  ...
  const items = import_react252.Children.toArray(children).reduce((acc, child, index4, array) => {
    const item = isElement2(child) ? (0, import_react252.cloneElement)(child, {
      ...getStyles2("breadcrumb", { className: child.props?.className }),
      key: index4
    }) : (0, import_react252.createElement)("div", { ...getStyles2("breadcrumb"), key: index4 }, child);
    acc.push(item);
    if (index4 !== array.length - 1) {
      acc.push(
        (0, import_react252.createElement)(Box, { ...getStyles2("separator"), key: `separator-${index4}` }, separator)
      );
    }
    return acc;
  }, []);
...
var Center = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime173.jsx)(Box, { ref, mod: [{ inline: inline2 }, mod], ...getStyles2("root"), ...others });
});
...
var Thumb2 = (0, import_react267.forwardRef)(({ position, ...others }, ref) => (0, import_jsx_runtime180.jsx)(
  Box,
  {
    ref,
    __vars: {
...
var ColorSlider = factory((_props, ref) => {
  ...
  const layers = overlays.map((overlay, index4) => (0, import_react268.createElement)("div", { ...getStyles2("sliderOverlay"), style: overlay, key: index4 }));
...
var Swatches = (0, import_react272.forwardRef)(
  ({
    ...
    const colors = data.map((color, index4) => (0, import_react272.createElement)(
      ColorSwatch,
      {
...
var HoverCardTarget = (0, import_react306.forwardRef)((props, ref) => {
  ...
  if (withinGroup && ctx.getReferenceProps && ctx.reference) {
    ...
    return (0, import_jsx_runtime217.jsx)(Popover.Target, { refProp, ref, ...others, children: (0, import_react306.cloneElement)(
      child,
...
var Indicator = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime221.jsxs)(Box, { ref, ...getStyles2("root"), mod: [{ inline: inline2 }, mod], ...others, children: [
...
var index2 = import_react313.useLayoutEffect;
...
var index3 = React17.forwardRef(TextareaAutosize);
...
var LoadingOverlay = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime228.jsx)(Transition, { transition: "fade", ...transitionProps, mounted: !!visible2, children: (transitionStyles) => (0, import_jsx_runtime228.jsxs)(Box, { ...getStyles2("root", { style: transitionStyles }), ref, ...others, children: [
...
var MenuTarget = (0, import_react333.forwardRef)((props, ref) => {
  ...
  return (0, import_jsx_runtime239.jsx)(Popover.Target, { refProp, popupType: "menu", ref, ...others, children: (0, import_react333.cloneElement)(child, {
    onClick,
    onMouseEnter,
    onMouseLeave,
...
var PillsInput = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime256.jsx)(PillsInputProvider, { value: { fieldRef, size: size2, disabled, hasError: !!error2, variant }, children: (0, import_jsx_runtime256.jsx)(
    InputBase,
    {
      size: size2,
      error: error2,
...
var NativeSelect = factory((props, ref) => {
  ...
  const options = getParsedComboboxData(data).map((item, index4) => (0, import_jsx_runtime260.jsx)(NativeSelectOption, { data: item }, index4));
  return (0, import_jsx_runtime260.jsx)(
    InputBase,
    {
      ...
      error: error2,
      unstyled,
      rightSection: rightSection || (0, import_jsx_runtime260.jsx)(ComboboxChevron, { size: size2, error: error2, unstyled }),
...
function PaginationItems({ dotsIcon }) {
  ...
  const items = ctx.range.map((page, index4) => {
    if (page === "dots") {
      return (0, import_jsx_runtime271.jsx)(PaginationDots, { icon: dotsIcon }, index4);
    }
  ...
  return (0, import_jsx_runtime276.jsxs)(import_jsx_runtime276.Fragment, { children: [
    (0, import_jsx_runtime276.jsx)(
      Group,
      {
        ...
        __size: size2,
        dir: "ltr",
        children: _value.map((char, index4) => (0, import_react367.createElement)(
          Input,
          {
            component: "input",
            ...getStyles2("pinInput", {
...
var TooltipFloating = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime294.jsxs)(import_jsx_runtime294.Fragment, { children: [
    ...
    (0, import_react385.cloneElement)(child, {
      ...childProps,
      [refProp]: targetRef,
      onMouseEnter,
      onMouseLeave
...
var RingProgress = factory((_props, ref) => {
  ...
  const curves = getCurves({
    ...
    rootColor
  }).map(({ data, sum, root, lineRoundCaps, offset: offset2 }, index4) => (0, import_react393.createElement)(
    Curve,
    {
      ...data,
      key: index4,
  ...
  return (0, import_jsx_runtime298.jsxs)(Box, { ...getStyles2("root"), size: size2, ref, ...others, children: [
...
var SemiCircleProgress = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime301.jsxs)(Box, { ref, size: size2, ...getStyles2("root"), ...others, children: [
    ...
    (0, import_jsx_runtime301.jsxs)("svg", { width: size2, height: size2 / 2, ...getStyles2("svg"), children: [
...
var Skeleton = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime304.jsx)(Box, { ref, ...getStyles2("root"), mod: [{ visible: visible2, animate }, mod], ...others });
});
...
function Marks({ marks, min: min2, max: max2, disabled, value, offset: offset2, inverted }) {
  ...
  const items = marks.map((mark, index4) => (0, import_react403.createElement)(
    Box,
    {
...
var Stepper = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime317.jsx)(StepperProvider, { value: { getStyles: getStyles2, orientation, iconPosition }, children: (0, import_jsx_runtime317.jsxs)(Box, { ...getStyles2("root"), ref, size: size2, ...others, children: [
...
var SwitchGroup = factory((props, ref) => {
  ...
  return (0, import_jsx_runtime318.jsx)(SwitchGroupProvider, { value: { value: _value, onChange: handleChange, size: size2, disabled }, children: (0, import_jsx_runtime318.jsx)(
    Input.Wrapper,
    {
      size: size2,
      ref,
...
function TableDataRenderer({ data }) {
  return (0, import_jsx_runtime322.jsxs)(import_jsx_runtime322.Fragment, { children: [
    ...
    data.head && (0, import_jsx_runtime322.jsx)(TableThead, { children: (0, import_jsx_runtime322.jsx)(TableTr, { children: data.head.map((item, index4) => (0, import_jsx_runtime322.jsx)(TableTh, { children: item }, index4)) }) }),
    data.body && (0, import_jsx_runtime322.jsx)(TableTbody, { children: data.body.map((row, rowIndex) => (0, import_jsx_runtime322.jsx)(TableTr, { children: row.map((item, index4) => (0, import_jsx_runtime322.jsx)(TableTd, { children: item }, index4)) }, rowIndex)) }),
    data.foot && (0, import_jsx_runtime322.jsx)(TableTfoot, { children: (0, import_jsx_runtime322.jsx)(TableTr, { children: data.foot.map((item, index4) => (0, import_jsx_runtime322.jsx)(TableTh, { children: item }, index4)) }) })
  ] });
}
...
var TagsInput = factory((_props, ref) => {
  ...
  const values2 = _value.map((item, index4) => (0, import_jsx_runtime332.jsx)(
    Pill,
    {
...
var Timeline = factory((_props, ref) => {
  ...
  const items = _children.map(
    (item, index4) => (0, import_react432.cloneElement)(item, {
      unstyled,
      __align: align,
      __active: item.props?.active || (reverseActive ? active >= _children.length - index4 - 1 : active >= index4),
      __lineActive: item.props?.lineActive || (reverseActive ? active >= _children.length - index4 - 1 : active - 1 >= index4)
    })
  );
...
var Tree = factory((_props, ref) => {
  ...
  const nodes = data.map((node, index4) => (0, import_jsx_runtime343.jsx)(
    TreeNode,
    {
      node,
      getStyles: getStyles2,
